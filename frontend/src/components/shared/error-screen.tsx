...
const ErrorScreen: FC<ErrorScreenProps> = ({ error }) => (
  <div data-id="error-screen" className="flex items-center justify-center h-screen bg-gray-50">
    <div className="text-center text-red-500 p-8 bg-red-50 rounded-xl border border-red-200 max-w-md">
      ...
      <Button data-id="btn-retry" variant="outline" className="mt-4" onClick={() => window.location.reload()}>
        Try Again
      </Button>
    </div>
  </div>
