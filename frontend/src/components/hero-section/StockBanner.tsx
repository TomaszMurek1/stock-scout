...
// Theme Configuration - Light Mode Adapter
...
const theme = {
  ...
  logoGradient: "from-indigo-600 to-blue-600", // Keep for branding logo

  decorativeGradient: "from-blue-400/10 to-emerald-400/10",

  widgetBg: "bg-white/60 backdrop-blur-md", // Darker widget background
...
export default function ElegantStockScanBanner() {
  ...
  const candleWidth = Math.max(chartWidth / displayData.length - 1.5, 2); // Adjusted spacing
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-4 w-full">
                ...
                <div className="flex flex-col justify-center items-end ml-auto">
                  <span className={`${theme.primaryText} font-mono font-bold text-lg leading-none`}>
