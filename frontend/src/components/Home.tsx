...
export default function Home() {
  ...
  return (
    <div data-id="home-page" className="max-w-[1400px] mx-auto p-8">
      <HeroSection />
      <ScenarioCarousel />
      <div data-id="home-search" className="mx-auto px-4 py-6 bg-gradient-to-r from-gray-100 to-gray-200 rounded-lg p-4 shadow-sm flex flex-col gap-10">
        <CompanySearch
