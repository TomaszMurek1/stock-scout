...
export const SummaryEmptyState = () => (
    <div data-id="summary-empty" className="p-12 text-center bg-white rounded-xl border border-dashed border-gray-300 shadow-sm">
...
export const SummaryLoadingState = () => (
    <div data-id="summary-loading" className="p-12 text-center bg-white rounded-xl border border-dashed border-gray-300 shadow-sm">
