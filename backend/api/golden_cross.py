"""Golden-cross scan route — thin wrapper around the shared cross-scan service."""
...
def run_golden_cross_scan(db: Session, request: GoldenCrossRequest) -> dict:
    """Execute a golden-cross scan (called from background task)."""
